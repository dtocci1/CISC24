...
HD_PWD='C:/Users/dylma/OneDrive/Documents/UMD 2019-2020 Spring/ECE 368/CISC24/Block RAM/Block RAM.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log blockRAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source blockRAM.tcl

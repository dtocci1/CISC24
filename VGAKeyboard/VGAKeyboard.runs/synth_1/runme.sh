...
HD_PWD='C:/Users/dylma/OneDrive/Documents/UMD 2019-2020 Spring/ECE 368/CISC24/VGAKeyboard/VGAKeyboard.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_RGB_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source VGA_RGB_Top.tcl

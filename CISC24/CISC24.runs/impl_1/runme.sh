...
HD_PWD='C:/Users/julia/Documents/GitHub/CISC24/CISC24/CISC24.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ControlModule.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ControlModule.tcl -notrace
